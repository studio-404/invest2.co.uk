			...
			<div class="col-md-4">
				<div class="card">
				  <div class="card-body">
				    ...
				    <p class="card-text">
				    	მთავარი ანგარიში: <strong><font color="green">158.20 ლ</font></strong><br />
						დროებითი ანგარიში: <strong><font color="red">15.58 ლ</font></strong><br />
						ინვესტირებული: <strong><font color="grey">15 000.00 ლ</font></strong><br />	
						გატანის პროცესში: <strong><font color="blank">150.00 ლ</font></strong>						
				    </p>
				  </div>
				</div>
			...
			<div class="col-md-8">
				...
				<?php
					...
					default:
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" id="paypal_checkout">
