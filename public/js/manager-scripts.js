...
var profileupdate = function(){
	var lang = typeof $("#lang").val() === "undefined" ? Config.mainLanguage : $("#lang").val();
	var ajaxFile = "/profileupdate";
	var header = "<h4>პროფილის განახლება</h4><p class=\"modal-message-box\"></p>";
...
var edit_profile_password = function(lang){
	var oldpassword = typeof $("#oldpassword").val() !== "undefined" ? $("#oldpassword").val() : '';
	var password = typeof $("#password").val() !== "undefined" ? $("#password").val() : '';
	var passwordConfirm = typeof $("#passwordConfirm").val() !== "undefined" ? $("#passwordConfirm").val() : '';
	var ajaxFile = "/editProfilePassword";
	...
	if(
		...
		$.ajax({
			method: "POST",
			url: Config.ajax + ajaxFile,
			data: { call: true, lang:lang, oldpassword:oldpassword, password:password, passwordConfirm:passwordConfirm }
		}).done(function( msg ) {
			var obj = $.parseJSON(msg);
			if(obj.Error.Code==1){
...
var formModuleEdit = function(idx, lang){
	...
	var additional1 = (typeof $("#additional1").val() !== "undefined" && $("#additional1").val()!="") ? $("#additional1").val() : "empty";
	var additional2 = (typeof $("#additional2").val() !== "undefined" && $("#additional2").val()!="") ? $("#additional2").val() : "empty";
